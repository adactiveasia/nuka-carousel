  ...
  (function (_React$Component) {
    ...
    function Carousel() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).apply(
          this,
          arguments
        )
      );
      ...
      _this.getTouchEvents = _this.getTouchEvents.bind(
        _assertThisInitialized(_this)
      );
      _this.getMouseEvents = _this.getMouseEvents.bind(
        _assertThisInitialized(_this)
      );
      ...
      _this.swipeDirection = _this.swipeDirection.bind(
        _assertThisInitialized(_this)
      );
      _this.autoplayIterator = _this.autoplayIterator.bind(
        _assertThisInitialized(_this)
      );
      _this.startAutoplay = _this.startAutoplay.bind(
        _assertThisInitialized(_this)
      );
      _this.stopAutoplay = _this.stopAutoplay.bind(
        _assertThisInitialized(_this)
      );
      _this.resetAutoplay = _this.resetAutoplay.bind(
        _assertThisInitialized(_this)
      );
      ...
      _this.previousSlide = _this.previousSlide.bind(
        _assertThisInitialized(_this)
      );
      _this.getTargetLeft = _this.getTargetLeft.bind(
        _assertThisInitialized(_this)
      );
      _this.onResize = _this.onResize.bind(_assertThisInitialized(_this));
      _this.onReadyStateChange = _this.onReadyStateChange.bind(
        _assertThisInitialized(_this)
      );
      _this.onVisibilityChange = _this.onVisibilityChange.bind(
        _assertThisInitialized(_this)
      );
      _this.setInitialDimensions = _this.setInitialDimensions.bind(
        _assertThisInitialized(_this)
      );
      _this.setDimensions = _this.setDimensions.bind(
        _assertThisInitialized(_this)
      );
      ...
      _this.getFrameStyles = _this.getFrameStyles.bind(
        _assertThisInitialized(_this)
      );
      _this.getSlideStyles = _this.getSlideStyles.bind(
        _assertThisInitialized(_this)
      );
      _this.getSlideTargetPosition = _this.getSlideTargetPosition.bind(
        _assertThisInitialized(_this)
      );
      _this.getSliderStyles = _this.getSliderStyles.bind(
        _assertThisInitialized(_this)
      );
      _this.getOffsetDeltas = _this.getOffsetDeltas.bind(
        _assertThisInitialized(_this)
      );
      _this.formatChildren = _this.formatChildren.bind(
        _assertThisInitialized(_this)
      );
      _this.getChildNodes = _this.getChildNodes.bind(
        _assertThisInitialized(_this)
      );
      _this.getSlideHeight = _this.getSlideHeight.bind(
        _assertThisInitialized(_this)
      );
      _this.findMaxHeightSlide = _this.findMaxHeightSlide.bind(
        _assertThisInitialized(_this)
      );
      return _this;
    }
    ...
    _createClass(Carousel, [
        ...
        value: function getTouchEvents() {
          ...
          return {
            ...
            onTouchMove: function onTouchMove(e) {
              var direction = _this2.swipeDirection(
                _this2.touchObject.startX,
                e.touches[0].pageX,
                _this2.touchObject.startY,
                e.touches[0].pageY
              );
              ...
              var length = _this2.props.vertical
                ? Math.round(
                    Math.sqrt(
                      Math.pow(
                        e.touches[0].pageY - _this2.touchObject.startY,
                        2
                      )
                    )
                  )
                : Math.round(
                    Math.sqrt(
                      Math.pow(
                        e.touches[0].pageX - _this2.touchObject.startX,
                        2
                      )
                    )
                  );
              ...
              _this2.setState({
                left: _this2.props.vertical
                  ? 0
                  : _this2.getTargetLeft(
                      _this2.touchObject.length * _this2.touchObject.direction
                    ),
                top: _this2.props.vertical
                  ? _this2.getTargetLeft(
                      _this2.touchObject.length * _this2.touchObject.direction
                    )
                  : 0
        ...
        value: function getMouseEvents() {
          ...
          return {
            ...
            onMouseMove: function onMouseMove(e) {
              ...
              var direction = _this3.swipeDirection(
                _this3.touchObject.startX,
                e.clientX,
                _this3.touchObject.startY,
                e.clientY
              );
              ...
              var length = _this3.props.vertical
                ? Math.round(
                    Math.sqrt(
                      Math.pow(e.clientY - _this3.touchObject.startY, 2)
                    )
                  )
                : Math.round(
                    Math.sqrt(
                      Math.pow(e.clientX - _this3.touchObject.startX, 2)
                    )
                  );
              _this3.touchObject = {
              ...
              _this3.setState({
                left: _this3.props.vertical
                  ? 0
                  : _this3.getTargetLeft(
                      _this3.touchObject.length * _this3.touchObject.direction
                    ),
                top: _this3.props.vertical
                  ? _this3.getTargetLeft(
                      _this3.touchObject.length * _this3.touchObject.direction
                    )
                  : 0
      ...
      },
      {
        ...
        value: function handleSwipe() {
          ...
          if (
            ...
            this.state.slideWidth / slidesToShow / 5
          ) {
          ...
          if (index >= React.Children.count(this.props.children) || index < 0) {
            ...
            if (index >= React.Children.count(this.props.children)) {
              ...
              this.setState(
                function (prevState) {
                  return {
                    left: _this4.props.vertical
                      ? 0
                      : _this4.getTargetLeft(
                          _this4.state.slideWidth,
                          prevState.currentSlide
                        ),
                    top: _this4.props.vertical
                      ? _this4.getTargetLeft(
                          _this4.state.slideWidth,
                          prevState.currentSlide
                        )
              ...
              this.setState(
                function (prevState) {
                  return {
                    left: _this4.props.vertical
                      ? 0
                      : _this4.getTargetLeft(-1, prevState.currentSlide),
                    top: _this4.props.vertical
                      ? _this4.getTargetLeft(-1, prevState.currentSlide)
                      : 0,
      ...
      },
      {
        ...
        value: function setInitialDimensions() {
          ...
          var slideWidth = this.props.vertical
            ? this.props.initialSlideHeight || 0
            : this.props.initialSlideWidth || 0;
          var slideHeight = this.props.vertical
            ? (this.props.initialSlideHeight || 0) * this.props.slidesToShow
            : this.props.initialSlideHeight || 0;
          var frameHeight =
            slideHeight +
            this.props.cellSpacing * (this.props.slidesToShow - 1);
          this.setState(
            {
